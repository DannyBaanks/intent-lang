...
DECLARED_GAPS se carga dinamicamente desde engine_lang/languages/*.yaml
via engine_lang.registry. No hardcodear gaps aca.
"""
...
DECLARED_GAPS.update(registry().declared_gaps)
